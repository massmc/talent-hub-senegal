            ...
            <div className="group relative grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              >
                <img 
                  ...
                  className="w-3/5 mx-auto mix-blend-multiply"
                />
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8 }}
                className="order-1 md:order-2 bg-sand-900/50 p-8 rounded-2xl backdrop-blur-sm border border-sand-700/30 hover:border-sand-500/50 transition-all duration-300"
              >
